...
from models.train_utils import load_selected_columns_from_hdf5_chunks, calculate_zero_shot
import numpy as np
import torch
...
for n_neighbors in [1, 3, 10, 30, 64, 100]:
    for target_variable, bound in [
        ...
        print(f"Processing {target_variable} with bound {bound} and neighbors {n_neighbors}")
        ...
        results[(n_neighbors, target_variable)] = {
